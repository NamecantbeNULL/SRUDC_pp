...
parser.add_argument('--data_dir', default='./data/UDC_syn/', type=str, help='path to dataset')
parser.add_argument('--save_dir', default='./saved_models/', type=str, help='path to models saving')
parser.add_argument('--result_dir', default='./results/', type=str, help='path to results saving')
parser.add_argument('--test_set', default='test', type=str, help='test dataset name')
parser.add_argument('--exp', default='UDC_syn', type=str, help='experiment setting')
args = parser.parse_args()


def SSIM_def(img1, img2):
	ssim_val = ssim(img1, img2, gaussian_weights=True, use_sample_covariance=False, multichannel=True, channel_axis=2,
					data_range=1.)
	return ssim_val
